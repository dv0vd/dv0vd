...
help:
	...
	$(call print-help,start-nginx-local,start local nginx server)
	...
	$(call print-help,start-coturn,start coturn server)
	$(call print-help,start-synapse,start synapse server)
	...
	$(call print-help,start-open-webui,start Open WebUI server)
	...
	$(call print-help,stop-coturn,stop coturn server)
	$(call print-help,stop-synapse,stop synapse server)
	...
	$(call print-help,stop-open-webui,stop Open WebUI server)
	...
	$(call print-help,restart-coturn,restart coturn server)
	$(call print-help,restart-synapse,restart synapse server)
	...
	$(call print-help,restart-open-webui,restart Open WebUI server)
	...
	$(call print-help,logs-coturn,get coturn server logs)
	...
	$(call print-help,logs-open-webui,get Open WebUI server logs)
	...
	$(call print-help,certbot-issue-open-webui,issue Lets enctypt certificate for Open WebUI)
